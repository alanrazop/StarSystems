...
module.exports = class Actividades {
    ...
    static fetchOne(id) {
        return db.execute('SELECT * FROM proyecto p, registra r, actividad a WHERE r.id_actividad = ? and a.id_actividad = r.id_actividad and a.id_proyecto = p.id_proyecto', [id] );
    }
